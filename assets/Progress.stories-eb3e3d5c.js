import{e as k}from"./index-ab0c6643.js";import"./styled-components.browser.esm-bf785d72.js";import"./index-76fb7be0.js";import"./_commonjsHelpers-de833af9.js";import"./jsx-runtime-ffb262ed.js";const C={title:"Components/Progress",component:k,tags:["autodocs"],argTypes:{kind:{options:["default","percent","completed","error"],control:{type:"inline-radio"}},size:{options:["sm","md"],control:{type:"inline-radio"}},percentage:{control:null}},args:{kind:"default",size:"md"}},e={argTypes:{percentage:{control:{type:"range",min:0,max:100,step:1}}},args:{percentage:10}},r={argTypes:{percentage:{control:{type:"range",min:0,max:100,step:1}}},args:{kind:"percent",percentage:10}},n={args:{kind:"completed"}},o={args:{kind:"error"}};var a,s,t;e.parameters={...e.parameters,docs:{...(a=e.parameters)==null?void 0:a.docs,source:{originalSource:`{
  argTypes: {
    percentage: {
      control: {
        type: "range",
